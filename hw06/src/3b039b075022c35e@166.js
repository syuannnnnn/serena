...
Plot.plot({
  ...
  color: {
    ...
    range: ['steelblue', 'orange'],  // 你可以根據需要更改顏色
    legend: true
  },
  marks: [
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["artistPublic.csv", {url: new URL("./files/667aba186a26c07d3244b88c02d330b85b99975b05379c75533d3330e380db9226ba67b65c5f9523c17cc7760c895d257676aa177cde44fd21b1dc132b0d35fa.csv", import.meta.url), mimeType: "text/csv", toString}],
    ["artistVer.csv", {url: new URL("./files/5adac470d593e4b3578ba799ac97e8d3f3e82a5149141c4da452afe40ad1b4d88fbb0a16c1c1dbadc79d345f739bbf181c7f76243779ee27bd1ee42d33ec78cd.csv", import.meta.url), mimeType: "text/csv", toString}]
  ]);
