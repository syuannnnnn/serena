...
md`<h2>結論</h2>
  <ul>
    <li><h3>關於工作地點的類型</h3></li>
    <h4>- 工作類型以個人工作室為大宗，比例高於三成，初步推測是因問卷主要填寫對象為藝術工作找以及一般民眾，而藝術工作者通常會有屬於自己的工作空間。</h4>
    <h4>- 代替空間為次要多數。主因可能和第一點相似: 問卷投放類型位藝術工作者，其多數在藝術相關領域工作。因此除了擁有自己的空間外，在藝術相關展場也會佔多數。</h4>
    <li><h3>是否有採取相關減碳行動</h3></li>
    <h4>- 根據問卷回應，多數問卷填寫者以現下可以快速著手的方法進行改善，例如減少包裝、使用廢材再利用等方法開始。 </h4>
    <h4>- 對於需要長期推動的策略(如在校宣導甚至修改相關政策推動等)方式，在本問卷中所佔比例都幾乎為零，推測是所需投入成本可能過高，以目前條件或許會有點棘手。</h4>`
)}
